...
rmd_file <- here("notebook/single-omic/nipals-weighted.Rmd")
## source utilities
...
load_pkgs(pkgs)
## render
rmarkdown::render(rmd_file, output_format = "html_document", params = list(nipals_ncomp = 10L, subset = c(0, 3000), rerun = TRUE, saveRDS = TRUE, 
                                                                           repeat_runs = 1L, props_NA = c(0)))